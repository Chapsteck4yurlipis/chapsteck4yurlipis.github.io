...
const NAMES = [        // Temporary Hardcoded Name List
    ...
    ['Feferi','Eridan','Gamzee','Equius','Vriska','Terezi','Kanaya','Nepeta','Karkat','Sollux','Tavros','Aradia','Nu','Xi','Omicron','Pi','Rho','Sigma','Tau','Upsilon','Phi','Chi','Psi','Omega']
];
...
function setup(){
    ...
    CAT_COLORS[6] = color(250,130,240);
    CAT_COLORS[7] = color(255,255,255);
    CAT_COLORS[8] = color(210,170,255);
    CAT_COLORS[SUBTROP] = {};
